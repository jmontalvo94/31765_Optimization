...
for step=1:-0.05:0.4;
    ...
    objectiveSDP=[objectiveSDP, value(sum(alfa_k,1))]
...
if slack==1
    semilogy(1:-0.05:0.4,ratioSDP_slack)
    ylabel('Eigenvalue Ratio')
    xlabel('Line Limits Decrease in Percentage')
    set(gca,'XDir','reverse')
else
    semilogy(1:-0.05:0.4,ratioSDP)
    ylabel('Eigenvalue Ratio')
    xlabel('Line Limits Decrease in Percentage')
    set(gca,'XDir','reverse')
end

display(objectiveSDP')
display(objectiveACOPF')